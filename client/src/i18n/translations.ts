...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    // Services page (new)
    services_seed_production_title: 'Certified Seed Production',
    services_seed_production_desc: 'We produce high-quality certified seeds following strict national and international standards. Our production facilities are equipped with modern technology to ensure seed purity and vigor.',
  ...
  rw: {
    ...
    // Services page (new)
    services_seed_production_title: 'Kuzana Imbuto Zemejwe',
    services_seed_production_desc: 'Dukorana imbuto zemejwe zifite ubwiza twakurikije amahame y\'igihugu n\'amahamwe yakagarije. Ibikorwa byacu biriho ubushobozi bw\'ubuhinga bushya kugira ngo hizere ubusugire n\'imbaraga z\'imbuto.',
  ...
  fr: {
    ...
    // Services page (new)
    services_seed_production_title: 'Production de semences certifiées',
    services_seed_production_desc: 'Nous produisons des semences certifiées de haute qualité selon des normes strictes.',
